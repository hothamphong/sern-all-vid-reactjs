    ...
    render() {
        ...
        return (
            <div className="manage-doctor-container">
                <div className="manage-doctor-tittle">
                ...
                <div className="more-infor">
                    ...
                    <div className="content-right">
                        ...
                        <textarea className="form-control"
                            onChange={(event) => this.hanleOnChangeText(event, 'description')}
                ...
                <div className="doctor-infor-extra row">
                    ...
                    <div className="col-4 form-group">
                        ...
                        <input className="form-control"
                            onChange={(event) => this.hanleOnChangeText(event, 'nameClinic')}
                    ...
                    <div className="col-4 form-group">
                        ...
                        <input className="form-control"
                            onChange={(event) => this.hanleOnChangeText(event, 'addressClinic')}
                    ...
                    <div className="col-4 form-group">
                        ...
                        <input className="form-control"
                            onChange={(event) => this.hanleOnChangeText(event, 'note')}
